...
/**
 * Created by small on 11/14/2017.
 */

public interface IConstants {
    public static final String APP_PREFERENCES = "cryptoviewersetting";
    public static final String KEY_SPINNER_INDEX = "SAVED_SPINNER_INDEX";
    public static final String CRYPTODATA = "CRYPTODATA";
    public static final String CRYPTOPAIR = "CRYPTOPAIR";
